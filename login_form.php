<html>
  <head>
	...
	<table border="3">
	<tr>
	<td bgcolor="#EED8AE"><font size="7"><p align="center">&nbsp; &nbsp; KHUSUS ADMIN &nbsp; &nbsp;</p></td>
	<td bgcolor="#EED8AE">
	<p align="center">
		<label for="username"><font size="5">Username &nbsp; &nbsp; &nbsp; </font></label><input type="text" name="username" id="username" /> 
		<br><br>
    <p>
		<label for="password"><font size="5">Password &nbsp; &nbsp; &nbsp; &nbsp; </font></label><input type="password" name="password" id="password" />
	  </p>
	</td></tr>
	</table>
	<br>
    <p align="center">
      <button type="submit" class="btn btn-primary" value="Login"><font size="5">Login</font></button></form>	
	</td></tr>
